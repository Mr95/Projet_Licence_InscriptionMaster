...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href=#" class="logo">Faculté <span class="lite">NTIC</span></a>
            <!--logo end-->
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Consulter Recours</h3>
					<ol class="breadcrumb">
          		...
          		<div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <%@page import="modele.Periodes"%>
                                    ...
                                    List<recours> list = f.getRecours() ;
                                                                   
                                    %>
                                    
                                   
                                    <%for(int i =0 ; i<list.size() ; i++){ %>         
                                    <%if(list.get(i).isEtat_traitement()==false){ %>
                                    <tr>
                                    <form  action="ControlleurRecours" method="Post">
                                        	
                                        	<input type="hidden" name="Recours" value="traiter">
                                        	
                                        	<input type="hidden" name="idEtudiant" value="<%=list.get(i).getId_etudiant()%>">
                                            <input type="hidden" name="idRecours" value="<%=list.get(i).getId_recours()%>">
                                            
                                           <%  etudiant e = f.getEtudiantByrecours(list.get(i).getId_etudiant());
                                           ...
                                           %>
                                            ...
                                            <td><%=e.getType_etudiant() %></td>
                                            
           		                            <td><%=f.nomFormation(e.getIDformation())%></td>
                                       		
                                       		<td><button class="btn btn-primary" type="submit"> Consulter </button></td> 	
