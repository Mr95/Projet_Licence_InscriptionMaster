		  ...
		  <div class="row">
              ...
              <div class="row">
               ...
               <form action="ajoutFormation" method="Post">
                 ...
                 <input type="hidden" name="ajouter/nombre" value="ajouter_formation">
                 
                  <div class="form-group">
                     <label class="col-sm-2 control-label">Nom Formation</label>
                  ...
                  <!--  div class="form-group">
                     <label class="col-sm-2 control-label">Code Formation</label>
                     <div class="col-sm-10">
                   ...
                   <div class="form-group">
                     <label class="col-sm-2 control-label">Nom département</label>
                     <div class="col-sm-10">
            ...
            <!-- onclick="confirm('vous confirmer ces dates ?')" -->
