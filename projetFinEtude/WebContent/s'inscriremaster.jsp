                  ...
                  <!-- alert notification start-->
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <%
                            Find find =new Find();
                            int ide=(int) request.getSession().getAttribute("id_etudiant") ;
                            etudiant e =f.getEtudiantById(ide);
                            %>
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><i class="fa fa-bars"></i>S'inscrire Master</li>
...
<div class="container-fluid">
  ...
  <form enctype="multipart/form-data" class="form-horizontal" role="form" method="post" action="controlleurInscription">
  
  <input type="hidden" name="inscription" value="interne">
   <%@page import="modele.Find" %>
                  <%@page import="java.util.List" %>
  ...
  <legend>Information général</legend>
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="file" accept=".pdf,.jpg,.png" class="form-control" name="annee1" >
            </div>
        </div>
        <div class="form-group">
        ...
        <label class="col-sm-2 control-label"></label>
         ...
         <%! String debutInscJour , finInscJour , debutInscMois ,finInscMois,current; 
             ...
             Periodes p =null ;
         // je dois aussi testé si l'etudiant est inscrit
