  ...
  <section id="container" class="">
     ...
     <header class="header dark-bg">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a href="prendrerdv.jsp">Prendre RDV</a></li>
                          <li class="active"><a href="joindrepiece.jsp">Joindre pièce</a></li>
                      </ul>
                  </li>
                  <li>
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-tasks"></i> Joindre Pièce</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.jsp">Accueil</a></li>
						<li><i class="fa fa-desktop"></i>Suivre Dossier</li>
						<li><i class="fa fa-tasks"></i>Joindre Pièce</li>
					</ol>
				</div>
			</div>
              <div class="row">
